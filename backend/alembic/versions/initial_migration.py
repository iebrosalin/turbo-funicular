...
def upgrade() -> None:
    ...
    # Создаем таблицу groups только если она не существует
    ...
    # Создаем таблицу assets только если она не существует
    ...
    # Создаем таблицу asset_groups (many-to-many связь) только если она не существует
    ...
    # Создаем таблицу scans только если она не существует
    ...
    # Создаем таблицу scan_jobs только если она не существует
    ...
    # Создаем таблицу scan_results только если она не существует
    ...
    # Создаем таблицу activity_logs только если она не существует
    ...
    # Создаем таблицу asset_change_logs только если она не существует
    ...
    # Создаем таблицу service_inventory только если она не существует
